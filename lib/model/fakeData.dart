...
Map homPagePosterMap = {
  "imgPosterURL": Assets.img.logo.path,
  "writer": "پارسا سجادیان",
  "view": "1984",
  "title": "مسیر یادگیری زبان های برنامه نویسی",
  "time": "یک روز پیش"
};

List<hashtag> hashtagList = [
  hashtag(tite: "هوش مصنوعی"),
  hashtag(tite: "فلاتر"),
  hashtag(tite: "طراحی وب"),
  hashtag(tite: "کاتلین"),
  hashtag(tite: "جاوااسکریپت"),
  hashtag(tite: "دارت"),
  hashtag(tite: "جاوا"),
];
...
// podcast data
List<PodcastModel> podcadtList = [
  PodcastModel(
    imageUrl:
        "https://tehranpodcast.ir/wp-content/uploads/2020/11/2022-06-04-07-12-59.png",
    namePodcast: "کتاب جیبی",
  ),
  PodcastModel(
    imageUrl: "https://tehranpodcast.ir/wp-content/uploads/2019/09/geek.jpg",
    namePodcast: "رادیو گیک",
  ),
  PodcastModel(
    imageUrl:
        "https://tehranpodcast.ir/wp-content/uploads/2020/03/1079549-1538150306202-28f2d96e0d2b5.jpg",
    namePodcast: "کارنکن",
  ),
  PodcastModel(
    imageUrl: "https://tehranpodcast.ir/wp-content/uploads/2023/01/500.jpg",
    namePodcast: "فول استک",
  ),
];
